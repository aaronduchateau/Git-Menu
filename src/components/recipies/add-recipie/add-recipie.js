        ...
        <FadeIn duration="300ms">
          ...
          >
            <div className="add_recipie_container">
              <h2>Italian Risotto with Broccoli and Chedeer</h2>
              ...
              <div className="space5" />
              <hr className="subtle-hr" />
              <p className="description_p">Risotto takes a while to cook properly, and it requires your attention as well as your time. For upwards of 20 minutes, you have one job and one job only, and that is to stir the rice while adding hot stock -a ladleful at a time- and cook the rice slowly so that the stock is absorbed. 
